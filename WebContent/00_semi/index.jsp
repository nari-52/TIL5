		...
		<section>
			<div id="section_new_product" class="new_back_size">
				<div id="section_new_product_slogan">
					...
					<button class="section_new_product_more" onclick="='notice/noticeList.sb'" >자세히보기</button>
				</div>
				<div class="section_new_product_limemojito back_size_lm" style="cursor: pointer;" onclick="='notice/noticeList.sb'"></div>
				<div class="section_new_product_doubleexpresso back_size_de" style="cursor: pointer;" onclick="='notice/noticeList.sb'"></div>
				<div class="section_new_product_applemango back_size_am" style="cursor: pointer;" onclick="='notice/noticeList.sb'"></div>
			</div>
			...
			<div id="section_reward">
				...
				<div id="reward_button">
					<button class="reward_button reward_btn_signup" type="button" onclick="='register/memberRegister.sb'" >회원가입</button>
					<button class="reward_button reward_btn_login" type="button" onclick="='login/loginIndex.sb'" >로그인</button>
					<br/>
					<button class="reward_button reward_btn_product" type="button" onclick="='product/menu.sb'" >더 많은 상품보기</button>
				</div>	
			</div>
			</section>
			...
			<div id="section_recommended_menu">
				...
				<img id="section_recommended_menu_1" src="images/nari/section_recommended_menu_1.jpg" width="500px" height="500px" style="cursor: pointer;" onclick="='product/menu.sb'"/>
			</div>
