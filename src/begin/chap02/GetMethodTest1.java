...
public class GetMethodTest1 extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		String[] foodArr  = request.getParameterValues("food"); // 배열로 복수의 값 받아오기
		...
		// *** 웹브라우저에 출력하기 *** // -----------------------------------------------
		// HttpServletResponse response 객체는 넘어온 데이터를 조작하여 결과물을 나타내고자 할 떄 쓰인다.
		...
		if(color != null) {
			out.printf("학력은 %s이며, %s 색을 좋아합니다.<br/><br/>", school, color);
		}
		else {
