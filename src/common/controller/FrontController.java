...
@WebServlet(
      ...
      urlPatterns = { "*.up" }, 
      initParams = { 
            @WebInitParam(name = "propertyConfig", value = "C:/myjsp/MyMVC/WebContent/WEB-INF/Command.properties", description = "*.up 에 대한 클래스의 매핑파일")
      })
public class FrontController extends HttpServlet {
   ...
   /*
       웹브라우저 주소창에서 *.up을 하면 FrontController 서블릿이 응대를 해오는데
   ...
   // *** 확인용 *** //
      // System.out.println("~~~ 확인용 ==> 서블릿 FrontController 의 init(ServeletConfig config) 메소드가 실행됨.");
      ...
      try {
         ...
         /*
         	...
         	~~~~ 확인용 key => /index.up
         	~~~~ 확인용 value => common.controller.IndexDontroller
...
//	   System.out.println("~~~ 확인용 ctxPath => " + ctxPath);
   ...
   } // end of private void requestProcess()------------------------------------------------
